    ...
    <div class="links">
        ...
        <div class="flex2">
            <div class="grid-box">
                ...
                <div class="box-2"> Maik</div>
                <div class="box-3"> Denis</div>
                <div class="box-4"> Oliver</div>
                <div class="box-5"> Jochen</div>
                <div class="box-6"> Andre</div>
                <form action="lehrkörperx.php" method="POST">
                </form>
